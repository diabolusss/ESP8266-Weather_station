...
//uncomment if flash is needed, otherwise keep unimplemented
//#define FLASH
...
class CCS811 {
  public: // Main interface
    ...
    CCS811(int slaveaddr=CCS811_SLAVEADDR_0,int nwake=-1);                   // Pin number connected to nWAKE (nWAKE can also be bound to GND, then pass -1), slave address (5A or 5B)
